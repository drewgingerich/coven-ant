...
public class SerialController : ScriptableObject
{
	...
	public SerialMessageInput messageListener;
	public float cooldown = 1;
	public float currentCooldown = 2; // Ignores messages at the start
		...
		if (ReferenceEquals(message, SERIAL_DEVICE_CONNECTED)) {
			...
			if( message != "" && message != null) {
				if( currentCooldown <= 0 ) {
					...
					Debug.LogWarning("Message " + message + " ignored due to cooldown remaining of " + currentCooldown);
					#endif
				}
			}
		}
